...
export interface Database {
  public: {
    Tables: {
      ...
      photos: {
        Row: { id: string; created_at: string; event_id: string; url: string; thumbnail_url: string | null; width: number | null; height: number | null; original_name: string | null; is_hidden: boolean; status: 'uploading' | 'processing' | 'ready' | 'error' }
        Insert: { id?: string; created_at?: string; event_id: string; url: string; thumbnail_url?: string | null; width?: number | null; height?: number | null; original_name?: string | null; is_hidden?: boolean; status?: 'uploading' | 'processing' | 'ready' | 'error' }
        Update: { id?: string; created_at?: string; event_id?: string; url?: string; thumbnail_url?: string | null; width?: number | null; height?: number | null; original_name?: string | null; is_hidden?: boolean; status?: 'uploading' | 'processing' | 'ready' | 'error' }
      }
      photo_faces: {
